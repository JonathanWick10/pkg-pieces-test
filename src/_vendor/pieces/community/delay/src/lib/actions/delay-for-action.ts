import {
  createAction,
  Property,
} from 'automation-pieces-framework-test';
import { ExecutionType, PauseType } from 'automation-shared-test';
import { markdownDescription } from '../common';
import { z } from 'zod';
import { propsValidation } from 'automation-pieces-common-test';
